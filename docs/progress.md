...
The next recommended task is [Stage 04 / Task 001 - Auth API](tasks/stage-04-auth/task-001-auth-api.md).
...
| --- | --- | --- |
| 1 | [Stage 04 / Task 001 - Auth API](tasks/stage-04-auth/task-001-auth-api.md) | Planned |
| 2 | [Stage 04 / Task 002 - Auth Frontend](tasks/stage-04-auth/task-002-auth-frontend.md) | Planned |
| 3 | [Stage 05 / Task 001 - Categories API](tasks/stage-05-expenses/task-001-categories-api.md) | Planned |
